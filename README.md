...
![Discription](https://github.com/user-attachments/assets/4a778202-1072-463a-bfa3-842226e300af) <img src="https://github.com/user-attachments/assets/3f2f67c8-2112-4e43-aff7-0c280b92d20d" />  
![Last Update](https://github.com/user-attachments/assets/e1d05f21-2a01-4ecf-94f3-b7bdff4d44dd) <img src="https://github.com/user-attachments/assets/7bbeb69c-bccd-4f60-8976-ba2446a3b39c" />  
...
# Access rights
In Delphi, access to the Windows system directory (usually ```C:\Windows\System32```) depends heavily on Windows user privileges ([UAC](https://learn.microsoft.com/en-us/windows/security/application-security/application-control/user-account-control/)), file system virtualization, and the ```32-bit/64-bit architecture```. Since modern versions of Windows block write access to this directory for standard users, you must explicitly adapt your application.
